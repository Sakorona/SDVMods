...
#pragma warning restore IDE0051 // Remove unused private members
        {
            ...
            RainAndWind.Reflection.GetField<Rectangle>(__instance, "sourceRect").SetValue(sourceRect);
        }
...
#pragma warning restore IDE0051 // Remove unused private members
        {
            b.Draw(RainAndWind.OurIcons.LeafSprites, __instance.position, new Rectangle?(___sourceRect), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 1E-06f);
            return false;
        }
    }
}
